...
import EssayTabs, { type EssayTabItem } from '@/components/EssayTabs';
...
/* ─────────────────────────────────────────────────────────────
   Essay content — defined outside the component so the server
   renders them once and passes them as RSC slots to EssayTabs
───────────────────────────────────────────────────────────── */
...
/* Combined three-part pecan pie essay */
const pecanPieFullEssay = (
  <>
    {pecanPie1Essay}
    <hr />
    <h3>Part Two: The Sticky Wicket of Pecan Pie&apos;s Origins</h3>
    {pecanPie2Essay}
    <hr />
    <h3>Part Three: Too Big Even for Texas</h3>
    {pecanPie3Essay}
  </>
);

/* ─────────────────────────────────────────────────────────────
   Research Findings tab definitions
───────────────────────────────────────────────────────────── */
const researchTabs: EssayTabItem[] = [
  {
    ...
    <>
      ...
      <div className={styles.wrapper}>
        ...
        <section className={styles.section}>
          ...
          <EssayTabs tabs={researchTabs} columns={2} />
        </section>
      </div>
    </>
  );
